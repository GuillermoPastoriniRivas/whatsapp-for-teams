const translations = {
  es: {
    ...
    admin: {
      ...
      plugins: "Plugins",
      pluginsDescription: "Funcionalidades adicionales para este numero",
      pluginOrders: "Pedidos",
      pluginOrdersDescription: "Permite tomar y gestionar pedidos desde este numero",
    },
    landing: {
    ...
    orders: {
      ...
      deliveryCost: "Envio",
      subtotal: "Subtotal",
      missingDeliveryCost: "Falta calcular envio",
      pickupAtStore: "Retira en el local",
  ...
  en: {
    ...
    admin: {
      ...
      plugins: "Plugins",
      pluginsDescription: "Additional features for this number",
      pluginOrders: "Orders",
      pluginOrdersDescription: "Enable order taking and management from this number",
    },
    landing: {
    ...
    orders: {
      ...
      subtotal: "Subtotal",
      missingDeliveryCost: "Missing delivery cost",
