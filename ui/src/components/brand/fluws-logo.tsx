/* Marca fluws: núcleo macizo + órbita de 310°.
 *
...
/* Espacio de 512.
 *
 * La órbita barre 310° y deja la boca arriba, entre 245° y 295° (en SVG el
...
const ORBIT_PATH = "M316 127.3A142 142 0 1 1 196 127.3";
...
/* Bbox real, contando los caps de la órbita y el trazo de la patita:
   x 75.8→421, y 104.3→430.3. El viewBox de `mark` lo encuadra con un respiro
   de 6. */
const MARK_VIEWBOX = "70 98 357 338";
