...
export type { BusinessProfile, BotBehavior, BusinessVertical, CatalogItem, FaqEntry, HandoffRules, AiContextConfig, AiRateLimits } from './ai-agent-config.entity.js';
